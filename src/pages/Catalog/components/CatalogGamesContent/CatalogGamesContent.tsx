...
function CatalogGamesContent() {
  ...
  "games": [
    ...
    {
      "id": "7",
      "imageUrl": "https://i.postimg.cc/z3R82y48/a93725bbb26a586f7064823bbdcd1ddcfbf8fc58-4.png' border='0' alt='a93725bbb26a586f7064823bbdcd1ddcfbf8fc58-4",
      "name": "Astrea",
      "desc": "Astrea — новинка в жанре roguelike c уникальными особенностями: здесь два вида урона: очищение и скверна, а еще вместо карт разыгрываются кубики. Соберите мощные кубики, чтобы очистить Астрею от скверны и спасти звездную систему.",
      "ganre": "Стратегия",
      "tags": [],
      "devTeamId": "1",
      "rating": 4.6,
